...
class Cell:
    ...
    def __str__(self):
        return f'Результат операции {self.amount* "*"}'
    ...
    def __sub__(self, other):
        ...
        return self.amount - other.amount if (self.amount - other.amount) > 0 else print('Отрицательно!')
    ...
    def make_order(self, cell_in_row):
        row = ''
        for _ in range(int(self.amount / cell_in_row)):
            row += f'{"*" * cell_in_row} \\n'
